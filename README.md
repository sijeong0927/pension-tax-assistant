...
- `app/api/v1/diagnose.py`: 총급여와 연금저축·IRP 납입액을 받아 최대 세액공제 효과를 반환하는 진단 API
...
> 본 서비스는 입력한 소득 구간과 공식 자료를 기반으로 한 참고용 시뮬레이션입니다. `maximum_tax_credit`은 공제대상 납입액에 공제율을 적용한 최대 세액공제 효과이며 실제 환급액이 아닙니다. 실제 적용액은 결정세액을 초과할 수 없으며, 최종 세액공제 적용 여부와 금액은 국세청 연말정산 신고 결과 또는 세무 전문가의 확인을 따릅니다.
